...
public class ClosedOrdersModel : PageModel
{
    private readonly ClothingRentalDbContext _context;

    public ClosedOrdersModel(ClothingRentalDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        // Lọc các đơn hàng đã đóng trong khoảng thời gian tạo đơn
        ...
        TotalRentalRevenue = allFiltered.Sum(o => o.TotalPrice);
        TotalDepositCollected = allFiltered.Sum(o => o.TotalDeposit);
        TotalPenaltyRevenue = allFiltered.Sum(o => o.TotalPenalty);
        TotalDiscount = allFiltered.Sum(o => o.DiscountAmount);
        TotalNetRevenue = allFiltered.Sum(o => o.FinalAmount);
